...
class GSTTextField extends StatefulWidget {
  ...
  const GSTTextField({
    ...
    this.pinBoxOuterPadding = const EdgeInsets.symmetric(horizontal: 0.0),
    required this.pinBoxColor,
    required this.highlightPinBoxColor,
  ...
  State<StatefulWidget> createState() {
    return GSTTextFieldState();
  }
}

class GSTTextFieldState extends State<GSTTextField>
  ...
  @override
  void didUpdateWidget(GSTTextField oldWidget) {
  ...
  Widget _buildPinCode(int i, BuildContext context) {
    Color borderColor;
    Color pinBoxColor = primaryColor;
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border(
            right:
                BorderSide(color: i != 14 ? Colors.grey : Colors.transparent),
          ),
        ),
        width: widget.pinBoxWidth,
        height: widget.pinBoxHeight,
